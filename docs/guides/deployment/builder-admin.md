...
Build Details show structured post and feed counts. Reader refresh Details show fetched
articles plus refreshed, stale, and failed feed counts. These values are generated by the build and
reader commands as JSON summaries, rather than inferred from log text.
