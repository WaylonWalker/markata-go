...
type Feed struct {
	...
	// Hidden indicates that the feed is intentionally hidden from sidebar
	// navigation. It remains visible in administrative inventories such as the TUI.
	Hidden bool

	// Automated indicates that the feed was generated by an auto-feed plugin.
	Automated bool
