...
func TestGlossaryPlugin_LinkTerms_Basic(t *testing.T) {
	...
	expected := `<a href="/glossary/api/" class="glossary-term" title="Application Programming Interface" data-preview="glossary" data-title="API" data-description="Application Programming Interface">API</a>`
