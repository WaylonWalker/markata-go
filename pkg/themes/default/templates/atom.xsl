        ...
        <body>
            <div class="feed-container">
                ...
                <div class="feed-notice">
                    ...
                    <details>
                        <summary>What is Atom? Popular feed readers</summary>
                        <p>Atom is a feed format (like RSS) that lets you subscribe to websites and get updates in one place. Here are some popular readers:</p>
                        <ul>
